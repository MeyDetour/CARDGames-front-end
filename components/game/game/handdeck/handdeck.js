...
import { getCurrentPlayer, getGameData } from "../../../../src/controller/game/dataStorage.js";
  ...
  sortedHandDeck.sort((a, b) => {
    ...
    if (!cardA || !cardB) return 0;
     ...
     if (cardA.value === cardB.value) {
      ...
      return (colorOrder[cardA.addedAttributs.couleur] || 0) - (colorOrder[cardB.addedAttributs.couleur] || 0);
    }
